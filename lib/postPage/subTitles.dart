...
class _SubTitlesState extends State<SubTitles> {
                ...
                body: SafeArea(
                    child: Column(
                      children: [
                            ...
                            Visibility(
                              ...
                              child: Container(
                                ...
                                child: FlatButton(
                                  ...
                                  onPressed: () async {
                                    showAlertDialogAdd(context, widget.index);
                                  },
                                ),
                              ),
                            ),
                        ...
                        getSubtitleFutureBuilder(context, widget.index),
                      ],
                    )
                )
            );
  ...
  Widget getSubtitleFutureBuilder(BuildContext context, int index){
    return FutureBuilder(
        future: FirebaseService().getPostDocuments(index),
                            ...
                            child: ListTile(
                              onTap: (){
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) =>Content(post: postList[index], anaindex: widget.index, index: index),
                                  ),
                                );
                              },
                              ...
                              children: [
                                ...
                                Visibility(
                                  ...
                                  child: IconButton(onPressed: () async {
                                    showAlertDialogUpdate(context, widget.index, index, postList[index]);
                                    postList = snapshot.data;
                                ...
                                Visibility(
                                  visible: isVisible,
                                  child: IconButton(onPressed: () async {
                                    showAlertDialogDelete(context, widget.index, index);
                                    postList = snapshot.data;
  ...
  showAlertDialogAdd(BuildContext context, int index) {
    ...
    Widget continueButton = TextButton(
      ...
      onPressed: () async {
        await FirebaseService().addSubTitle(index, textEditingController.text);
        Navigator.of(context).pop();
        setState(() {
        });
      },
  ...
  showAlertDialogUpdate(BuildContext context, int anaindex, int index, PostModel post) {
    ...
    Widget continueButton = TextButton(
      child: Text("Devam Et", style: TextStyle(color: Colors.red)),
      onPressed: () async {
        await FirebaseService().updateSubTitle(anaindex, index, post);
        Navigator.of(context).pop();
        setState(() {
        });
      },
  ...
  showAlertDialogDelete(BuildContext context, int anaindex, int index) {
    ...
    Widget continueButton = TextButton(
      child: Text("Devam Et", style: TextStyle(color: Colors.red)),
      onPressed: () async {
        await FirebaseService().deleteSubTitle(anaindex, index);
        Navigator.of(context).pop();
        setState(() {
        });
      },
